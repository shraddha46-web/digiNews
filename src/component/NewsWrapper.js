...
export default function NewsWrapper(props) {
  ...
  function getNews(pageNo) {
    ...
    let newsUrl = `https://newsapi.org/v2/top-headlines?country=${props.country}&apiKey=${props.api_key}&page=${pageNo}&pageSize=${props.pageSize}`;

    //All top news with selected category
    if (props.category !== "top headlines") {
      newsUrl = `https://newsapi.org/v2/top-headlines?country=${props.country}&category=${props.category}&apiKey=${props.api_key}&page=${pageNo}&pageSize=${props.pageSize}`;
    }
